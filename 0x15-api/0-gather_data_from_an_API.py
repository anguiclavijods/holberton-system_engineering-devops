...
response_todo = requests.\
    get("https://jsonplaceholder.typicode.com/todos?userId=" + str(id_user))
user_tasks = response_todo.json()
total_tasks = len(user_tasks)

url = "https://jsonplaceholder.typicode.com/todos?userId={}&completed=true"\
    .format(id_user)
